...
const collections = {
  'contacts': require('./collections/default'),
  'events': require('./collections/default'),
  'races': require('./collections/default'),
  'courses': require('./collections/default')
}
...
function setup(context, collectionName, collectionMethods)
{
  ...
  app.post('*', json, access, json, createSchema, create);
